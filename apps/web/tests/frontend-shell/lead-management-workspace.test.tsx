...
describe("LeadList CRM workspace", () => {
  ...
  it("renders the lead form, filters, and lead list", async () => {
    ...
    expect(container.textContent).toContain("Mohamed Sayed - CONTACTED - HIGH");
  });

  it("applies filters", async () => {
    const { getByRole } = renderWithProviders(<LeadList />);

    await waitFor(() => expect(mocks.listLeads).toHaveBeenCalledWith({}));
